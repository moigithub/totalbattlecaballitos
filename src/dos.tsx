...
import { mobCommonCursedSquad29 } from './monsterc.ts'
  ...
  const loadPresetArmy = (preset: string) => {
    ...
    switch (preset) {
      ...
      case 'elf20G7Mercs2':
        ...
        break
      case 'cursed20G5Mercs':
        decodeAndLoadArmySetup(cursed20G5Mercs)
        break
      case 'cursed20G5S5M4':
  ...
  return (
    <>
      ...
      >
        <div
          className={cn(
            'p-4 border-2 border-blue-400/25 max-w-[960px] min-w-[860px] ',
            isVisible ? 'w-[calc(100% - 64px)]' : ' w-full'
          )}
        >
              ...
              <div className='flex'>
                ...
                <div className='ml-auto flex   items-center'>
                  <label className='ml-2'>
                    <input
                      type='checkbox'
                      onChange={e => setShowMiniCardOrderer(e.target.checked)}
                      checked={showMiniCardOrderer}
                    />
                    show/hide MiniCard sorter
                  </label>
                </div>
              </div>
        ...
        <div className='relative'>
          {showMiniCardOrderer && (
            <section className={cn('p-1 bg-gray-900 max-w-[220px] sticky top-[57px]')}>
              <MiniCardSorter />
            </section>
          )}
        </div>
