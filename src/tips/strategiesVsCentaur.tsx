export const CentaurStrategiesTip = () => {
  return (
    <div>
      ...
      <p>Target centaur before it hit you, so you can kill or reduce its amount</p>
      <p>
        Introduce a ranged unit with huge health so it can survive the centaur attack, centaur have
        50% bonus against ranged units, so they will prefer those instead your catapults
      </p>
      <p>
        Reduce your catapults/units amount so its max health+bonus are below centaur strength
