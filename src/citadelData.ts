...
export const citadele10: Citadel = {
  stacks: [
    { id: '0', unit: objectDB.walls, unitsAmount: 90, damage: 0, turn: 0, hasAttacked: false },
    { id: '1', unit: objectDB.bearV, unitsAmount: 9, damage: 0, turn: 0, hasAttacked: false },
    {
      id: '2',
    ...
    { id: '4', unit: objectDB.druidII, unitsAmount: 100, damage: 0, turn: 0, hasAttacked: false },
    { id: '5', unit: objectDB.dwarf, unitsAmount: 2200, damage: 0, turn: 0, hasAttacked: false }
  ]
}
...
export const citadele15: Citadel = {
  // walls: { hp: 700 * 30_000 },
  stacks: [
    { id: '0', unit: objectDB.walls, unitsAmount: 700, damage: 0, turn: 0, hasAttacked: false },

    { id: '1', unit: objectDB.entVI, unitsAmount: 21, damage: 0, turn: 0, hasAttacked: false },
    {
      id: '2',
    ...
    { id: '3', unit: objectDB.druidII, unitsAmount: 1100, damage: 0, turn: 0, hasAttacked: false },
    {
      id: '4',
...
export const citadele20: Citadel = {
  ...
  stacks: [
    { id: '0', unit: objectDB.walls, unitsAmount: 3650, damage: 0, turn: 0, hasAttacked: false },
    {
      id: '1',
...
export const citadele25: Citadel = {
  ...
  stacks: [
    { id: '0', unit: objectDB.walls, unitsAmount: 31900, damage: 0, turn: 0, hasAttacked: false },
    {
      id: '1',
      unit: objectDB.lifeDragonVII,
      unitsAmount: 480,
...
export const citadele30: Citadel = {
  ...
  stacks: [
    { id: '0', unit: objectDB.walls, unitsAmount: 135000, damage: 0, turn: 0, hasAttacked: false },
    {
      id: '1',
      unit: objectDB.lifeDragonVII,
      unitsAmount: 2300,
...
export const citadelc20: Citadel = {
  ...
  stacks: [
    { id: '0', unit: objectDB.walls, unitsAmount: 9200, damage: 0, turn: 0, hasAttacked: false },
    {
      id: '1',
...
export const citadelc25: Citadel = {
  ...
  stacks: [
    { id: '0', unit: objectDB.walls, unitsAmount: 77500, damage: 0, turn: 0, hasAttacked: false },
    {
      id: '1',
      unit: objectDB.cursedDragonVII,
      unitsAmount: 120,
