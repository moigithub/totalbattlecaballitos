    ...
    <>
      ...
      <div className='p-5 pt-[56px]'>
        ...
        <ol>
          ...
          <li>
            or create a Battle Report to get the bonuses values for the troops you going to use
          </li>
        ...
        <div>
          <ul style={{ color: 'pink' }}>
            ...
            <li>
              Send sacrifices first (the stack with highest str) ie: 500k strength for the whole
              stack
            </li>
